...
PerfectCasino.Core.RegisterEntity("pcasino_slot_machine", {
	-- General data
	general = {
		limitUse = {d = false, t = "bool"} -- Можно ли использовать несколько машин сразу?
	},
	-- Bet data
	bet = {
	...
	combo = {
		...
		{c = {"melon", "melon", "melon"}, p = 1.1, j = false},
		{c = {"cherry", "cherry", "cherry"}, p = 1.2, j = false},
	...
	jackpot = {
		toggle = {d = true, t = "bool"}, -- Колокольный звон.
		startValue = {d = 10000, t = "num"}, -- Начальное значение джекпота
		betAdd = {d = 0.5, t = "num"}, -- Процент от ставки, добавляемый к джекпоту
	},
	-- Chance data
	chance = {
