...
PerfectCasino.Core.RegisterEntity("pcasino_roulette_table", {
	-- Bet data
	bet = {
		betLimit = {d = 15000, t = "num"},  -- Максимальная сумма ставок по умолчанию
		default = {d = 1000, t = "num"}, -- Ставка по умолчанию
		max = {d = 5000, t = "num"},  -- Максимальная ставка по умолчанию 
		min = {d = 1000, t = "num"}, -- Минимальная ставка по умолчанию
		iteration = {d = 1000, t = "num"} -- Увеличение ставки при нажатии на стрелку
	},
	general = {
