...
---------------------------------------------------------------------------]]
IGS.CHARTS("Спинов в Казино",function(cb)
	IGS.ChartCountValuesOfColumn(cb, TABLE_PURCHASES, "Спинов в Казино", "casino")
end):SetDescription(
	"Каждая 5 покупка это пачка стиков разработчику проекта. " ..
	"Фотографии с доказательством покупок стиков находятся в дискорде"
)

IGS.CHARTS("Больше побегов от админов",function(cb)
	IGS.ChartCountValuesOfColumn(cb, TABLE_PURCHASES, "Побегов из Jail", "unjail")
end):SetDescription(
	"Чуваки из этой таблицы настолько богаты, что у меня просто нет слов. " ..
	"Они купили больше всего побегов из тюрьмы! Это говорит о том, что они богатые нарушители!"
)
