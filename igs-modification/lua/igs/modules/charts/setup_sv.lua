...
---------------------------------------------------------------------------]]
IGS.CHARTS("Бутылок колы",function(cb)
	IGS.ChartCountValuesOfColumn(cb, TABLE_PURCHASES, "Бутылок", "coca_cola")
end):SetDescription(
	"Умножьте число из этой таблицы на 2 и узнаете, сколько литров колы купил человек разработчику проекта. " ..
	"Фотографии с доказательством покупок колы находятся на форуме TRIGON.IM в пр. кабаке"
)
